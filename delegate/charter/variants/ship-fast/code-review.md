...
3. If approved: task moves to `in_approval`. Auto-merge (no-review repos), AI reviewer approval (via `task_approve`/`task_reject`), or human approval depending on repo merge policy.
