...
- **Keep messages brief.** Get to the point quickly. Lead with the key information — status, decision, or ask. Skip preamble and pleasantries. A good message is 1-3 short sentences. If you need more detail, use bullet points. Do not restate the task description back; the recipient already knows it.
